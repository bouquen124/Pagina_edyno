...
class ProductoUserController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        return view('ux.producto.create',compact('estados','categorias'));
    }
    ...
    public function show($id)
    {
        ...
        $imagenes = Ilustrable::where('ilustrable_id', $id)->where('ilustrable_type', 'App\Models\Producto')->paginate(5);        
        
        return view('ux.producto.show', compact('producto', 'imagenes'));
    }
    ...
    public function edit($id)
    {
        ...
        $imagenes = Ilustrable::where('ilustrable_id', $id)->where('ilustrable_type', 'App\Models\Producto')->paginate(5);        
        $numeroimagenes = Ilustrable::where('ilustrable_id', $id)->where('ilustrable_type', 'App\Models\Producto')->count();
        $estados =Estado::pluck('nombre','id');
        $categorias=Categoria::pluck('nombre','id');
        return view('ux.producto.edit', compact('producto', 'estados', 'categorias', 'imagenes', 'numeroimagenes'));
    }
