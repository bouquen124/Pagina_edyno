        ...
        <div class="grey-background wow fadeIn">
            <div class="container">
                <div class="heading-block page-title wow fadeInUp">
                    ...
                    <a
                        href="  {{ route('servicio.edit', ['id' => $servicio->id, 'idd' => $servicio->id, 'type' => 'Servicio', 'back' => Request::path()]) }} ">
                        <span class="comments">
                            Editar
                        </span>
                    </a>
                    ...
                    "return confirm('Seguro que quiere borrar este Post?')"]) !!}
                    {!! Form::close() !!}
